package com.algorelpublic.zambia.Shimmer;
...
/**
 * Created by android on 7/18/17.
 */

public class ShimmerRadioButton extends RadioButton implements ShimmerViewBase {

    private ShimmerViewHelper shimmerViewHelper;

    public ShimmerRadioButton(Context context) {
        super(context);
        shimmerViewHelper = new ShimmerViewHelper(this, getPaint(), null);
        shimmerViewHelper.setPrimaryColor(getCurrentTextColor());
    }

    public ShimmerRadioButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        shimmerViewHelper = new ShimmerViewHelper(this, getPaint(), attrs);
        shimmerViewHelper.setPrimaryColor(getCurrentTextColor());
    }

    public ShimmerRadioButton(Context context, AttributeSet attrs, int defStyle) {
